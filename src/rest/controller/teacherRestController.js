...
var TeacherRestController = function(TeacherModel) {
     ...
     * 
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 0, "name":"ilker_0", "lastname":"kiris_0", "title":"freshman ", "age":200, "isFullTime":false}' http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -d     '{"teacherId": 1, "name":"ilker_1", "lastname":"kiris_1", "title":"FreshMan",  "age":201, "isFullTime":false}' http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" --data '{"teacherId": 2, "name":"ilker_2", "lastname":"kiris_2", "title":" freshman", "age":202, "isFullTime":true}'  http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 3, "name":"ilker_3", "lastname":"kiris_3", "title":" freshman", "age":203, "isFullTime":true}'  http://localhost:9016/teachers
     * 
     ...
     * 
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update",   "lastname":"kiris_0", "title":"freshman ", "age":200, "isFullTime":false}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update_2", "lastname":"kiris_0", "title":"freshman ", "age":200, "isFullTime":false, "updatedOn":"2017-12-03T12:39:06.446Z"}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update_2", "lastname":"kiris_0", "title":"freshman ", "age":200, "isFullTime":false, "updatedOn":"'"$(date +%Y-%m-%dT%H:%M:%S)"'"}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 3, "name":"ilker_3_update",   "lastname":"kiris_3", "title":"freshman ", "age":200, "isFullTime":false, "updatedOn":"'"$(date +%Y-%m-%dT%H:%M:%S)"'"}' http://localhost:9016/teachers/5a2f2505c96a552334fdc762
     * 
     ...
     * 
       curl -X PATCH -H "Content-Type: application/json" -i -d '{"title":"sophomore", "age":123, "isFullTime":false}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
     * 
     * @param {*} req 
     * @param {*} res 
     */
